...
namespace geopm
{
    ...
    class NodeActivityAgent : public Agent
    {
        public:
            NodeActivityAgent();
            NodeActivityAgent(PlatformIO &plat_io, const PlatformTopo &topo, ActivityPerformanceModel &activity_perf_model);
        ...
        private:
            ...
            ActivityPerformanceModel &m_activity_perf_model;
