...
#ifndef CPUREGIONACTIVITYAGENT_HPP_INCLUDE
#define CPUREGIONACTIVITYAGENT_HPP_INCLUDE
...
/// @brief Agent
class CPURegionActivityAgent : public geopm::Agent
{
    public:
        CPURegionActivityAgent();
        CPURegionActivityAgent(geopm::PlatformIO &plat_io, const geopm::PlatformTopo &topo);
        virtual ~CPURegionActivityAgent() = default;
